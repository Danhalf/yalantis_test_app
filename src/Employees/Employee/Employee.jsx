        ...
        { props.users[props.letter].length ? props.users[props.letter].map((user, idx) =>
            ...
            >
                ...
                <div className={ style.item_radio }>
                    <input label="active" type="radio" name={ `${ user.id }_active` } value={ user.active }
                           defaultChecked={user.active} onChange={ () => props.changeHandler(props.letter, idx, true) }/>
                    <input label="not active" type="radio" name={ `${ user.id }_active` } value={ !user.active }
                           defaultChecked={!user.active} onChange={ () => props.changeHandler(props.letter, idx, false) }/>
                </div>
            </li>
